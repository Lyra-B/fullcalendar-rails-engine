module FullcalendarEngine
  class SessionSeries < ActiveRecord::Base
    ...
    after_create :create_sessions_until_end_time

    def create_sessions_until_end_time(end_time=RECURRING_SESSIONS_UPTO)
    ...
    def recurring_period(period)
      Session::REPEATS.key(period.titleize).to_s.downcase
    end
